document.addEventListener("DOMContentLoaded", () => {
  const region = document.getElementById("ins-school-region");
  const province = document.getElementById("ins-school-province");
  const city = document.getElementById("ins-school-city");
  const name = document.getElementById("ins-school-name");
  const type = document.getElementById("ins-school-type");
